import{a as e,g as t,h as n,i as r,l as i,n as a,o,p as s,t as c,u as l}from"./iconBase-02BbQUN6.js";import{a as u,c as d,f,g as p,h as m,i as h,l as g,m as _,n as v,o as y,p as b,r as ee,s as te,t as x}from"./index-BzJzsDqg.js";var S=`/React-Movie-Search-App/assets/no-poster-DPZEAbfg.png`,ne=`/React-Movie-Search-App/assets/no-backdrop-E_I-G8xw.png`,C=`eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjMjNhNWQ4MjcyNjE3ZjZmNzAyMWJhNGM0OTg0NjRmZiIsIm5iZiI6MTY5OTM1ODgxNi4xMjcsInN1YiI6IjY1NGEyODYwNTMyYWNiMDExYjEwYzI5YiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.JaMiiyblV0gutYXA0_BostrvfuMitxlET6G1ohNUjp4`,w=`a830e5b0f010507b63a389aefcf3d052`,T=`https://api.themoviedb.org/3`,E=`https://image.tmdb.org/t/p/`,D=(e,t=500)=>e?`${E}w${t}${e}`:S,O=(e,t=1280)=>e?`${E}w${t}${e}`:ne,k=(e,t=185)=>e?`${E}w${t}${e}`:null,A={method:`GET`,headers:{accept:`application/json`,Authorization:C}},re=async(e=1)=>{let t=`api_key=${w}&page=${e}`,n=await fetch(`${T}/trending/movie/week?${t}`,A);if(!n.ok)throw console.error(`Failed to fetch trending movies`),Error(n.statusText);return n.json()},ie=async(e=1)=>{let t=await fetch(`${T}/movie/top_rated?api_key=${w}&language=en-US&page=${e}`,A);if(!t.ok)throw console.error(`Failed to fetch top rated movies`),Error(t.statusText);return t.json()},ae=async e=>{let t=await fetch(`${T}/movie/${e}?api_key=${w}`,A);if(!t.ok)throw console.error(`Failed to fetch movie details`),Error(t.statusText);return t.json()},oe=async(e,t=1)=>{let n=await fetch(`${T}/search/movie?api_key=${w}&query=${e}&page=${t}&language=en-US`,A);if(!n.ok)throw Error(n.statusText);return n.json()},j=async e=>{let t=await fetch(`${T}/movie/${e}/reviews?api_key=${w}`,A);if(!t.ok)throw Error(t.statusText);return t.json()},se=async e=>{let t=await fetch(`${T}/movie/${e}/credits?api_key=${w}`);if(!t.ok)throw Error(t.statusText);return t.json()},ce=async()=>{let e=await fetch(`${T}/genre/movie/list?api_key=${w}`);if(!e.ok)throw console.error(`Failed to fetch genres`),Error(e.statusText);return e.json()},le=async()=>{let e=await fetch(`${T}/genre/tv/list?api_key=${w}`);if(!e.ok)throw Error(e.statusText);return e.json()},M={method:`GET`,headers:{accept:`application/json`,Authorization:C}},ue=async(e=1)=>{let t=await fetch(`${T}/tv/popular?api_key=${w}&page=${e}`,M);if(!t.ok)throw Error(t.statusText);return t.json()},de=async e=>{let t=await fetch(`${T}/tv/${e}?api_key=${w}`,M);if(!t.ok)throw Error(t.statusText);return t.json()},fe=async e=>{let t=await fetch(`${T}/tv/${e}/reviews?api_key=${w}`);if(!t.ok)throw Error(t.statusText);return t.json()},N=async e=>{let t=await fetch(`${T}/tv/${e}/credits?api_key=${w}`);if(!t.ok)throw Error(t.statusText);return t.json()},P=async(e,t)=>{let n=await fetch(`${T}/${t}/${e}/similar?api_key=${w}`);if(!n.ok)throw Error(n.statusText);return n.json()},F=async e=>{let t=await fetch(`${T}/person/${e}?api_key=${w}`);if(!t.ok)throw Error(t.statusText);return t.json()},I=async e=>{let t=await fetch(`${T}/person/${e}/combined_credits?api_key=${w}`);if(!t.ok)throw Error(t.statusText);return t.json()},L=p.ul`
  display: flex;
  flex-direction: row;
  flex-wrap: nowrap;
...
`,St=({actor:e})=>{let{name:t,also_known_as:n,birthday:i,deathday:a,place_of_birth:o,popularity:s,profile_path:c,biography:l,known_for_department:u,homepage:d}=e,f=D(c,500),p=(s/10).toFixed(1);return(0,z.jsxs)(yt,{children:[(0,z.jsx)(bt,{children:(0,z.jsx)(`img`,{src:f,alt:t})}),(0,z.jsxs)(xt,{children:[(0,z.jsxs)(`div`,{className:`actor-header`,children:[(0,z.jsx)(`h2`,{children:t}),(0,z.jsx)(`span`,{className:`actor-role`,children:u})]}),(0,z.jsxs)(`div`,{className:`actor-meta`,children:[(0,z.jsxs)(`p`,{className:`details__label`,children:[`Popularity:`,` `,(0,z.jsxs)(`span`,{className:`details__value `,children:[s?`${p} / 10`:`Unknown`,` `]})]}),(0,z.jsx)(Ct,{birthday:i,deathday:a}),(0,z.jsx)(wt,{deathday:a}),(0,z.jsxs)(`p`,{className:`details__label`,children:[`Birthplace:`,(0,z.jsxs)(`span`,{className:`details__value`,children:[` `,o||`Unknown`]})]})]}),(0,z.jsx)(`div`,{className:`actor-extra`,children:(0,z.jsxs)(`p`,{className:`details__label`,children:[`Also known as:`,(0,z.jsxs)(`span`,{className:`details__value `,children:[` `,n?.length?n.join(`, `):t]})]})}),(0,z.jsx)(`p`,{className:`actor-bio`,children:l}),(0,z.jsx)(r,{to:d})]})]})},Ct=({birthday:e,deathday:t})=>{if(!e)return null;let n=new Date(e),r=t?new Date(t):new Date,i=n.toLocaleDateString(`en-US`,{day:`numeric`,month:`long`,year:`numeric`}),a=Math.floor((r-n)/(1e3*60*60*24*365.25));return(0,z.jsxs)(`p`,{className:`details__label`,children:[`Born: `,(0,z.jsx)(`span`,{className:`details__value `,children:i}),` `,(0,z.jsxs)(`span`,{children:[` (`,a,` years old)`]})]})},wt=({deathday:e})=>e?(0,z.jsxs)(`p`,{className:`details__label`,children:[`Dead: `,(0,z.jsx)(`span`,{className:`details__value `,children:new Date(e).toLocaleDateString(`en-US`,{year:`numeric`,month:`long`,day:`numeric`})})]}):null,Tt=n({default:()=>Et}),Et=()=>{let{id:e}=l(),[t,n]=(0,Y.useState)([]),[r,a]=(0,Y.useState)(!1),[o,s]=(0,Y.useState)(null),c=i(),u=(0,Y.useCallback)(async e=>{try{a(!0),s(``),c.pathname.includes(`movies`)?n((await se(e)).cast):c.pathname.includes(`series`)&&n((await N(e)).cast)}catch{s(`Failed to load cast`)}finally{a(!1)}},[c.pathname]);return(0,Y.useEffect)(()=>{e&&u(e)},[e,u]),r?(0,z.jsx)(te,{count:t.length}):o?(0,z.jsx)(v,{message:o,onRetry:()=>u(e)}):t.length===0?(0,z.jsx)(ct,{}):(0,z.jsx)(`div`,{className:`cast__scroll-wrapper`,children:(0,z.jsx)(L,{children:t.map(e=>(0,z.jsx)(ot,{actor:e},e.id))})})};export{de as _,$ as a,re as b,Z as c,Ce as d,X as f,ue as g,F as h,pt as i,Ae as l,B as m,St as n,$e as o,_e as p,vt as r,Xe as s,Tt as t,we as u,ae as v,oe as x,ie as y};