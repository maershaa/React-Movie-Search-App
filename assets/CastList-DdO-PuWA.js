...
`,he=({movie:e,closeModal:t})=>{let[n,i]=(0,Z.useState)([]);(0,Z.useEffect)(()=>{ie().then(e=>i(e.genres)).catch(e=>console.error(e))},[]);let{original_title:a,adult:o,release_date:s,genre_ids:c,media_type:l=`movie`,overview:u,backdrop_path:d}=e,f=(0,Z.useMemo)(()=>n.filter(e=>c?.includes(e.id)),[n,c]);return e?(0,R.jsx)(me,{children:(0,R.jsxs)(`article`,{children:[(0,R.jsxs)(`header`,{className:`modal__header`,style:{backgroundImage:`url(${D(d,1280)})`},children:[(0,R.jsx)(v,{closeModal:t}),(0,R.jsx)(`h2`,{className:`modal__title`,children:a})]}),(0,R.jsxs)(`section`,{className:`modal__content`,children:[(0,R.jsxs)(`div`,{className:`modal__info`,children:[(0,R.jsx)(`span`,{className:`modal__year`,children:s?.substring(0,4)}),o&&(0,R.jsx)(`span`,{className:`modal__age`,children:`18+`}),(0,R.jsx)(`span`,{className:`modal__mediaType`,children:l}),(0,R.jsx)(U,{genres:f})]}),(0,R.jsx)(`p`,{className:`modal__overview`,children:u}),(0,R.jsx)(r,{to:`/movies/${e.id}`,className:`modal__info-btn`,children:`More Info`})]})]})}):null},ge=m.div`
  position: relative;
  z-index: 3;
...
`,Ie=({movie:e})=>{if(!e)return null;let{backdrop_path:t,poster_path:n,original_title:r,vote_average:i,vote_count:a,overview:o,release_date:s,runtime:c,revenue:l,production_countries:u,tagline:d,genres:f}=e,p=E(t,1280),m=D(n,500);return(0,R.jsx)(Ne,{children:(0,R.jsx)(Pe,{className:`movie-details__backdrop`,style:{backgroundImage:`url(${p})`},children:(0,R.jsx)(b,{children:(0,R.jsxs)(`div`,{className:`movie-content`,children:[(0,R.jsx)(`img`,{src:m,alt:r,className:`movie-poster`,loading:`lazy`}),(0,R.jsxs)(Fe,{children:[(0,R.jsx)(`h1`,{className:`movie__title`,children:r}),(0,R.jsx)(X,{vote_average:i,vote_count:a,release_date:s}),(0,R.jsx)(`p`,{className:`movie__overview`,children:o}),(0,R.jsx)(U,{genres:f}),(0,R.jsx)(De,{runtime:c,revenue:l,production_countries:u,tagline:d}),(0,R.jsx)(h,{})]})]})})})})},Le=m.h4`
  font-size: 1.5rem;
