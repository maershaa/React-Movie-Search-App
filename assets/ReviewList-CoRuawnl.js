import{i as e,t}from"./jsx-runtime-D-oznMWL.js";import{a as n,c as r,d as i,r as a,t as o}from"./iconBase-55VGzWiC.js";import{c as s,i as c,l,o as u,s as d,t as f,u as p}from"./index-CJapfQ-C.js";import"./CastList-CtQwRqhY.js";var m=`/React-Movie-Search-App/assets/no-poster-DPZEAbfg.png`,h=`eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjMjNhNWQ4MjcyNjE3ZjZmNzAyMWJhNGM0OTg0NjRmZiIsIm5iZiI6MTY5OTM1ODgxNi4xMjcsInN1YiI6IjY1NGEyODYwNTMyYWNiMDExYjEwYzI5YiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.JaMiiyblV0gutYXA0_BostrvfuMitxlET6G1ohNUjp4`,g=`https://api.themoviedb.org/3`,_=`https://image.tmdb.org/t/p/`,v=`c23a5d8272617f6f7021ba4c498464ff`,y={method:`GET`,headers:{accept:`application/json`,Authorization:h}},b=async(e=1)=>{let t=`api_key=${v}&page=${e}`,n=await fetch(`${g}/trending/movie/week?${t}`,y);if(!n.ok)throw console.error(`Failed to fetch trending movies`),Error(n.statusText);return n.json()},x=async(e=1)=>{let t=await fetch(`${g}/movie/top_rated?api_key=${v}&language=en-US&page=${e}`,y);if(!t.ok)throw console.error(`Failed to fetch top rated movies`),Error(t.statusText);return t.json()},S=async(e,t=1)=>{let n=await fetch(`${g}/movie/${e}?api_key=${v}&page=${t}`,y);if(!n.ok)throw console.error(`Failed to fetch movie details`),Error(n.statusText);return n.json()},ee=async(e,t=1)=>{let n=await fetch(`${g}/search/movie?api_key=${v}&query=${e}&page=${t}&primary_release_year=2025&include_adult=true&language=en-US`,y);if(!n.ok)throw Error(n.statusText);return n.json()},te=async e=>{let t=await fetch(`${g}/movie/${e}/reviews?api_key=${v}`,y);if(!t.ok)throw Error(t.statusText);return t.json()},ne={method:`GET`,headers:{accept:`application/json`,Authorization:h}},re=async()=>{let e=await fetch(`${g}/genre/movie/list?api_key=${v}`,ne);if(!e.ok)throw console.error(`Failed to fetch genres`),Error(e.statusText);return e.json()},ie=p.ul`
  ...
  gap: 20px;
`,C=t(),w=({moviesArr:e,openModal:t})=>(0,C.jsx)(ie,{children:e.map(e=>(0,C.jsx)(E,{movie:e,openModal:t},e.id))}),T=p.li`
  width: 300px;
...
`,M=({movie:e,closeModal:t})=>{let[n,r]=(0,k.useState)([]);(0,k.useEffect)(()=>{re().then(e=>r(e.genres)).catch(e=>console.error(e))},[]);let{original_title:i,adult:o,release_date:c,genre_ids:l,media_type:u,overview:d,backdrop_path:f}=e,p=(0,k.useMemo)(()=>n.filter(e=>l?.includes(e.id)),[n,l]);return e?(0,C.jsx)(j,{children:(0,C.jsxs)(`article`,{children:[(0,C.jsxs)(`header`,{className:`modal__header`,style:{backgroundImage:`url(${`${_}w1280/${f}`})`},children:[(0,C.jsx)(s,{closeModal:t}),(0,C.jsx)(`h2`,{className:`modal__title`,children:i})]}),(0,C.jsxs)(`section`,{className:`modal__content`,children:[(0,C.jsxs)(`div`,{className:`modal__info`,children:[(0,C.jsx)(`span`,{className:`modal__year`,children:c?.substring(0,4)}),o&&(0,C.jsx)(`span`,{className:`modal__age`,children:`18+`}),(0,C.jsx)(`span`,{className:`modal__mediaType`,children:u}),(0,C.jsx)(q,{genres:p})]}),(0,C.jsx)(`p`,{className:`modal__overview`,children:d}),(0,C.jsx)(a,{to:`/movies/${e.id}`,className:`modal__info-btn`,children:`More Info`})]})]})}):null},N=p.div`
  position: relative;
  z-index: 3;
...
`,z=({rating:e})=>{let t=Math.round(e/2);return(0,C.jsx)(R,{children:[...Array(t)].map((e,t)=>(0,C.jsx)(c,{className:`star-icon`},t))})},B=p.li`
  display: flex;
  flex-direction: column;
  justify-content: start;
  align-items: baseline;
...
`,W=({review:e})=>{let{author_details:{username:t,avatar_path:n,rating:r},content:i,created_at:a}=e,[o,s]=(0,k.useState)(!1),[c,l]=(0,k.useState)(null),f=new Date-new Date(a),p=Math.floor(f/(1e3*60)),m=Math.floor(f/(1e3*60*60)),h=Math.floor(f/(1e3*60*60*24)),g;g=p<60?`${p} minutes ago`:m<24?`${m} hours ago`:`${h} days ago`;let v=e=>{l(e),s(!0)},y=()=>{s(!1),l(null)};return(0,C.jsxs)(B,{onClick:()=>v(e),children:[(0,C.jsxs)(V,{children:[(0,C.jsx)(u,{src:n?`${_}w185${n}`:null,name:t,variant:`circle`}),(0,C.jsxs)(H,{children:[(0,C.jsxs)(`p`,{className:`review__user-name`,children:[`@`,t]}),(0,C.jsx)(`p`,{className:`review__date`,children:g})]})]}),(0,C.jsx)(z,{rating:r,created_at:a}),(0,C.jsx)(U,{children:(0,C.jsx)(`p`,{className:`review__text`,children:i})}),o&&(0,C.jsx)(d,{closeModal:y,children:(0,C.jsx)(L,{review:c,reviewDateText:g,closeModal:y})})]})},G=({countries:e})=>e?.length?(0,C.jsxs)(`p`,{children:[(0,C.jsx)(`span`,{className:`movie-details__label`,children:`Countries: `}),e.map((t,n)=>(0,C.jsxs)(`span`,{className:`movie-details__value`,children:[t.iso_3166_1,n<e.length-1?`, `:``]},t.iso_3166_1))]}):null,K=p.ul`
  display: flex;
  gap: 8px;
  list-style: none;
...
`,q=({genres:e})=>(0,C.jsx)(K,{children:e.map(e=>(0,C.jsx)(`li`,{className:`genre-tag`,children:(0,C.jsxs)(`span`,{children:[` `,e.name]})},e.id))}),J=p.div`
  display: flex;
  align-items: start;
  justify-content: flex-start;
  flex-wrap: wrap;
...
`,Y=({runtime:e,revenue:t,production_countries:n,tagline:r})=>(0,C.jsxs)(J,{children:[(0,C.jsx)(ce,{runtime:e}),(0,C.jsx)(se,{revenue:t}),(0,C.jsx)(G,{countries:n}),(0,C.jsx)(`p`,{className:`tagline`,children:r})]}),ae=p.div`
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 5px;
...
`,ue=({vote_average:e,vote_count:t,release_date:n})=>(0,C.jsxs)(le,{children:[(0,C.jsx)(X,{rating:e}),(0,C.jsx)(Q,{}),(0,C.jsx)(fe,{count:t}),(0,C.jsx)(Q,{}),(0,C.jsx)(Z,{date:n})]}),de=p.span`
  color: var(--text-color);
  font-size: 1rem;
`,fe=({count:e})=>{let t=e??0;return(0,C.jsxs)(de,{children:[t>=1e3?`${(t/1e3).toFixed(1).replace(`.0`,``)}K+`:t,` Review`,t===1?``:`s`]})},pe=p.section``,$=p.div`
  position: relative;
  min-height: 520px;
  display: flex;
  align-items: center;
...
`,_e=()=>(0,C.jsxs)(ge,{children:[(0,C.jsxs)(`ul`,{children:[(0,C.jsx)(`li`,{children:(0,C.jsx)(a,{to:`cast`,children:`Cast`})}),(0,C.jsx)(`hr`,{className:`divider`}),(0,C.jsx)(`li`,{children:(0,C.jsx)(a,{to:`reviews`,children:`Reviews`})})]}),(0,C.jsx)(n,{})]}),ve=p.div`
  display: flex;
  flex-direction: column;
  gap: 20px;
...
`,ye=()=>(0,C.jsxs)(ve,{children:[(0,C.jsx)(`h2`,{class:`no-reviews__title`,children:`There are no reviews yet`}),(0,C.jsx)(`p`,{class:`no-reviews__text`,children:`Be the first to share your thoughts!`})]}),be=p.h4`
  font-size: 1.5rem;
